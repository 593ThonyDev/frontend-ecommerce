import { PATH_ADMIN_ABOUT, PATH_ADMIN_COMPANY, PATH_ADMIN_HOME, PATH_BLOG_ADMIN, PATH_CATEGORIA_PRODUCTOS_ADMIN, PATH_CLIENTES_ADMIN, PATH_EMPLEADOS_ADMIN, PATH_ORDERS_ADMIN, PATH_PRODUCTOS_ADMIN, PATH_USERS_ADMIN } from "../../../../routes/private/admin/PrivatePaths"
        ...
        <header className="h-16 sm:h-16 flex items-center z-30 w-full sticky top-0 bg-primary-50 lg:bg-white border-b border-primary-100">
            <div className="container mx-auto lg:px-6 md:px-2 px-1 flex items-center justify-between">
                ...
                <div className="flex items-center flex-row-reverse justify-center">
                    <Link to={PATH_ADMIN_HOME} className="p-2 my-auto uppercase text-black-500 font-black lg:text-3xl text-2xl flex">
