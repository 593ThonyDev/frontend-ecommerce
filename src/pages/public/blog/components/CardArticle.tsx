...
const CardArticle: React.FC<ArticleDto> = (props) => {
    return (
        <div className="group sm:flex lg:rounded-xl dark:focus:ring-black-600 bg-primary-50 lg:border lg:border-black-100">
            <div className="flex-shrink-0 relative lg:rounded-s-xl overflow-hidden w-full h-[200px] sm:w-[250px] sm:h-[350px]">
                <Link to={PATH_BLOG_ARTICULO_ID + props.idArticle + "/" + props.title.replace(/\s+/g, '-')}>
            ...
            <div className="grow">
                <div className="p-4 flex flex-col h-full sm:p-6">
                    <Link to={PATH_BLOG_ARTICULO_ID + props.idArticle + "/" + props.title.replace(/\s+/g, '-')} className="text-lg sm:text-2xl w-fit font-bold hover:text-primary-800 text-primary-600 uppercase line-clamp-2"
