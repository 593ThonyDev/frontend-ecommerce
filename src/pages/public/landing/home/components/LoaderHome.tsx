...
import { PATH_PRODUCTOS, PATH_NOSOTROS } from "../../../../../routes/public/Paths"

const LoaderHome = () => {
    return (
        <div className="animate-pulse bg-primary-50 flex relative z-20 items-center overflow-hidden lg:mb-24">
            <div className="container mx-auto px-6 flex relative py-4 lg:py-16 flex-col-reverse sm:flex-row">
                ...
                <div className="sm:w-1/3 lg:w-3/5 relative pb-2.5 -mt-2">
                    <div className="flex items-center justify-center lg:py-0 md:py-0 py-8">
