...
import { getCustomerOrEmploye, getToken, setToken } from "../../../functions/AuthApi";
...
import { PATH_ORDERS_ADMIN } from "../../../routes/private/admin/PrivatePaths";
...
const checkOrder = () => {
  ...
  const checkOrderStatus = async () => {
    try {
      if (idCustomer && orderCode) {
        setToken();
        const responseDetails = await axios.get(`${API_URL}order/check/${idCustomer}/${orderCode}`);
        if (responseDetails) {
                        ...
                        <div className="grid h-fit py-2 lg:bg-primary-50 rounded-2xl px-3 lg:px-4 lg:py-4 md:sticky md:-top-40 lg:sticky lg:top-16">
                          ...
                          <div className=" gap-y-2">                            
                            ...
                            <div className="flex justify-between pt-1">
                              ...
                              <div className=" line-clamp-1 ml-2 text-black-500 font-bold hover:underline hover:text-primary-900">
                            ...
                            <div className="grid justify-between pt-1">
                              ...
                              <span className=" line-clamp-1 lg:mb-0 mb-1 text-black-500">{orderCode}</span>
                            </div>
                            <div className="grid justify-between pt-1">
                        ...
                        <div className="lg:my-4 md:my-4 md:px-3">
                          <div className=" bg-primary-100 px-3 h-fit lg:mt-0 mt-5 lg:rounded-xl md:rounded-xl">
                            <div className="grid justify-center items-center p-2 pb-3 w-full sticky top-16 mb-1 bg-primary-100">
                              <h2 className="text-xl lg:text-3xl uppercase font-semibold text-black-500">Detalles de la compra</h2>
