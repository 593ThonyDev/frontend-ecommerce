...
const BlogEmploye = () => {
    return (
        <React.Fragment>
            <div className=" w-full justify-center flex-1 max-w-6xl mx-auto md:px-6 lg:pt-8 bg-white">
                <div className=" sticky top-16 w-full backdrop-blur-xl bg-white/70 pb-2 pt-1 z-20 mb-2">
