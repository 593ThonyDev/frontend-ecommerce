...
import { PATH_ARTICLE_ADMIN_VIEW_ID } from "../../../../../routes/private/admin/PrivatePaths"
import { formatDate } from "../../../../../functions/Funtions"
import { PATH_BLOG_ARTICULO_ID, PATH_EMPLOYE_ID } from "../../../../../routes/public/Paths"
const CardArticle: React.FC<ArticleDto> = (props) => {
    return (
        <div className="group sm:flex lg:rounded-xl dark:focus:ring-black-600 bg-primary-50 lg:border lg:border-primary-100">
            ...
            <div className="grow">
                <div className="p-4 flex flex-col h-full sm:p-6">
                    <Link to={PATH_BLOG_ARTICULO_ID + props.idArticle} className="text-lg sm:text-xl w-fit font-bold hover:text-primary-800 text-primary-600 uppercase line-clamp-2">
                        {props.title}
                    </Link>
                    <p className="mt-2 text-black-600 dark:text-gray-400 line-clamp-5 cursor-default">
                        {props.description}
                    </p>
                    ...
                    <div className="mt-5 sm:mt-auto">
                        <div className="flex items-center">
                            <Link
                                to={PATH_EMPLOYE_ID + props.employe.idEmploye + "/" + props.employe.fullName.replace(/\s+/g, '-')}
