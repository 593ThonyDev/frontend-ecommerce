...
import { PATH_EMPLOYE_ID } from "../../../routes/public/Paths";
...
const EmployeList = () => {
    ...
    return (
        <div>
            <div className="grid w-full justify-center pb-4">
            ...
            {isLoading ? (
                ...
                <div className="w-full justify-center">
                    < div className="grid lg:grid-cols-4  md:grid-cols-2 gap-5 w-full lg:px-16" >
                        {
                            data.map(employe => (
                                <Link to={PATH_EMPLOYE_ID + employe.idEmploye + "/" + employe.fullName?.replace(/\s+/g, '-')} className="border border-primary-400/40 flex-shrink-0 relative overflow-hidden bg-primary-100 rounded-3xl max-w-xs mx-auto w-full h-screen/2">
