                    ...
                    <div className="lg:px-3 text-black-900 rounded-xl lg:pt-1">
                        ...
                        <div className="lg:px-3 text-black-900">
                            ...
                            <div className="lg:flex grid lg:pb-0 pb-1">
                                <Link to={PATH_EMPLEADO_EMPLOYE_ID + formData.employe.idEmploye + "/" + formData.employe.fullName.replace(/\s+/g, '-')} className="lg:ml-8 ml-4 lg:w-44 lg:h-44 h-32 w-32 relative lg:-mt-20 -mt-24 border-4 border-primary-200 rounded-full overflow-hidden z-20">
                                ...
                                <div className="text-left pt-3">
                                    ...
                                    <div className="flex justify-between px-5 items-end">
                                        <div className="flex">
                                            ...
                                            <Link
                                                to={PATH_EMPLEADO_EMPLOYE_ID + formData.employe.idEmploye + "/" + formData.employe.fullName.replace(/\s+/g, '-')}
