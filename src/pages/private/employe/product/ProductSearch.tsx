...
import { PATH_PRODUCTO_EMPLOYE_ID } from '../../../../routes/private/employe/PrivatePathsEmploye';
                        ...
                        <>
                            ...
                            {product.map((product) => (
                                <Combobox.Option key={product.idProduct} value={product.idProduct}>
                                    {({ active }) => (
                                        <Link to={PATH_PRODUCTO_EMPLOYE_ID + product.idProduct + "/" + product.name?.replace(/\s+/g, '-')}>
