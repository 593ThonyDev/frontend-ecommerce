                ...
                <div
                    ...
                    <div className="relative z-10 mx-auto max-w-md">
                        ...
                        <div
                            ...
                            <p>
                                Esta es la seccion donde podemos gestionar a nuestros consumidores en la plataforma.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div className="relative z-10 mx-auto max-w-md">
                        ...
                        <div
                            className="pt-2 text-base leading-7 text-black-600 transition-all duration-300 group-hover:text-white/90">
                            <p>
                                Esta es la seccion de valores netos adquiridos con la gestion de esta paltaforma.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div className="relative z-10 mx-auto max-w-md">
                        ...
                        <div
                            className="pt-2 text-base leading-7 text-black-600 transition-all duration-300 group-hover:text-white/90">
                            <p>
                                En esta seccion nos permite saber la cantidad de productos que estamos gestionando.                                 
                            </p>
                        </div>
                    </div>
                </div>
