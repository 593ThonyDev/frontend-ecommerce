...
import { PATH_ADMIN_ABOUT_EDIT } from "../../../../routes/private/admin/PrivatePaths";
    ...
    return (loading ? <LoaderAbout /> :
        <React.Fragment>
            <div className="flex w-full justify-between sticky top-16 z-20 bg-white lg:px-14 px-3 py-2 border-b border-primary-100">
                <div className=" uppercase my-auto font-semibold text-primary-400">Seccion nosotros</div>
                <Link to={PATH_ADMIN_ABOUT_EDIT} className="bg-warning-400/65 backdrop-blur-lg hover:bg-warning-400 px-3 py-1.5 text-white rounded-full uppercase font-semibold">
                    Editar
                </Link>
            </div>
