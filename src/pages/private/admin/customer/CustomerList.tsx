import { PATH_CLIENTES_ADMIN, PATH_CLIENTE_ADMIN_ID, PATH_CLIENTE_ADMIN_NEW } from "../../../../routes/private/admin/PrivatePaths";
                ...
                <div className="w-full">
                    {
                        ...
                        )) : <NotFoundAdmin message="No existen registros" error="201" link={PATH_CLIENTE_ADMIN_NEW} />
                    }
                    ...
                    {isError && (  // Si hay un error, muestra un mensaje de error
                        <NotFoundAdmin message={errorMessage} error="500" link={PATH_CLIENTES_ADMIN} />
                    )}
                </div >
            )}
        </>
